...
public abstract class BaseDAO<T> {
    ...
    public Map monitorSecondLevelCache() {
        Map entries = sessionFactory.getStatistics()
                .getSecondLevelCacheStatistics("org.hibernate.cache.internal.StandardQueryCache")
                .getEntries();
        System.out.println("------------------------cache status start-------------------->");
        System.out.println("------------------------cache status -------------------->" + entries);
        System.out.println("------------------------cache status end-------------------->");
        return entries;
    }
